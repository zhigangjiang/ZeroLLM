...
class ModelArguments:
    ...
    config_name: Optional[str] = field(
        default="/root/projects/happy-llm/ZeroLLM/autodl-tmp/model/Qwen2.5-1.5B", metadata={"help": "预训练使用，Config 文件地址"}
    )
    tokenizer_name: Optional[str] = field(
        default="/root/projects/happy-llm/ZeroLLM/autodl-tmp/model/Qwen2.5-1.5B", metadata={"help": "预训练 Tokenizer 地址"}
    )
...
class DataTrainingArguments:
    ...
    train_files: Optional[List[str]] = field(
        default_factory=lambda: ["/root/projects/happy-llm/ZeroLLM/autodl-tmp/dataset/seq_monkey_datawhale_small.jsonl"],
