...
def init_model():
    ...
    # 加载预训练权重
    ckp = '/root/projects/happy-llm/ZeroLLM/autodl-tmp/model/base_model_215M/pretrain_1024_18_6144.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="/root/projects/happy-llm/ZeroLLM/autodl-tmp/model/sft_model_215M", help="输出目录")
    ...
    parser.add_argument("--data_path", type=str, default="/root/projects/happy-llm/ZeroLLM/autodl-tmp/dataset/data/BelleGroup_sft.jsonl", help="训练数据路径")
