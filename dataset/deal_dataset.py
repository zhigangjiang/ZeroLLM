...
pretrain_data = 'src/dataset/mobvoi_seq_monkey_general_open_corpus.jsonl'
output_pretrain_data = 'src/dataset/seq_monkey_datawhale.jsonl'
...
sft_data = 'src/dataset/BelleGroup/train_3.5M_CN.json'
output_sft_data = 'src/dataset/BelleGroup/BelleGroup_sft.jsonl'
